...
class Sub_cabutpernyataan extends CI_Controller {
	function index(){
		...
		//cabut pernyataan
		$data['cabut'] = $this->perkara_sub->get_info_cabut($idperkara);

		$this->load->vars($data);
		$this->load->view('perkara_tab/pasca_pailit/sub_cabutpernyataan');
	}
}