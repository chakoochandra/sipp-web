...
class Sub_laporankurator extends CI_Controller {
	function index(){
		...
		//laporankurator
		$data['laporankurator'] = $this->perkara_sub->get_info_lapkurator($idperkara);

		$this->load->vars($data);
		$this->load->view('perkara_tab/pasca_pailit/sub_laporankurator');
	}
}