...
class Sub_pengumuman extends CI_Controller {
	function index(){
		...
		//pengumuman
		$data['pengumuman'] = $this->perkara_sub->get_info_pengumuman($idperkara);

		$this->load->vars($data);
		$this->load->view('perkara_tab/pasca_pailit/sub_pengumuman');
	}
}