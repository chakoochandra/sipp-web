...
class Sub_rehabilitasi extends CI_Controller {
	function index(){
		...
		//rehabilitasi
		$data['rehabilitasi'] = $this->perkara_sub->get_info_rehabilitasi($idperkara);

		$this->load->vars($data);
		$this->load->view('perkara_tab/pasca_pailit/sub_rehabilitasi');
	}
}