...
<div style="font-size:14px;width:90%;">
	<table>
		<tr><td style='padding-left:5px;color: #648C03;font-size: 15px;'><b>GUGATAN LAIN-LAIN</b></td></tr>
		<tr>
				...
				<div class="cssTable" style='width:100%'>
					<table>
						...
						<tbody>
                            ...
                            $no = 0;
							if($gugatanlainlain!=''){
								if($gugatanlainlain->num_rows>0){
									foreach ($gugatanlainlain->result() as $row) { $no++;
										echo '<tr>';
                                            echo '<td>'.$no.'</td>';
