...
{   
    ...
    echo ( '<html><head><title>SQLyog HTTP Tunneling</title></head>'.           
           ...
           '<p align="center"><img src="https://www.webyog.com/images/header.jpg" alt="Webyog"><p>' 
...
$username       = 'pasdadbuser';

$pwd            = 'pasdadbuser@401262';                                          
...
// $mysql = new mysqli($host, $username, $pwd, $db, $port);
// var_dump($mysql);;
// if ($mysql->connect_error) {
//     die('Connect Error (' . $mysql->connect_errno . ') ' . $mysql->connect_error);
// }

// // Return success message to ensure that SQLyog receives a valid response
// echo "Connection to MySQL server successful!";exit;
